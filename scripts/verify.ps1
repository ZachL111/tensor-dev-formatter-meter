...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-tensor-dev-formatter-detail.ps1

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-tensor-dev-formatter-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-tensor-dev-formatter-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-tensor_dev_formatter_meter-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
